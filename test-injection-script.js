(function() {
  ...
  // Generated at: 2025-12-04T16:38:06.267Z
...
(function() {
  ...
  const config = {
    mode: "minimal",
    voices: [{"name":"Google US English","lang":"en-US","localService":false,"default":true},{"name":"Google UK English Female","lang":"en-GB","localService":false,"default":false}]
  };
...
(function() {
  ...
  const standardLayout = new Map([["KeyA","a"],["KeyB","b"],["KeyC","c"],["KeyD","d"],["KeyE","e"],["KeyF","f"],["KeyG","g"],["KeyH","h"],["KeyI","i"],["KeyJ","j"],["KeyK","k"],["KeyL","l"],["KeyM","m"],["KeyN","n"],["KeyO","o"],["KeyP","p"],["KeyQ","q"],["KeyR","r"],["KeyS","s"],["KeyT","t"],["KeyU","u"],["KeyV","v"],["KeyW","w"],["KeyX","x"],["KeyY","y"],["KeyZ","z"],["Digit0","0"],["Digit1","1"],["Digit2","2"],["Digit3","3"],["Digit4","4"],["Digit5","5"],["Digit6","6"],["Digit7","7"],["Digit8","8"],["Digit9","9"],["Minus","-"],["Equal","="],["BracketLeft","["],["BracketRight","]"],["Backslash","\\"],["Semicolon",";"],["Quote","'"],["Backquote","`"],["Comma",","],["Period","."],["Slash","/"],["Space"," "],["Enter","Enter"],["Tab","Tab"],["Backspace","Backspace"],["Delete","Delete"],["ArrowUp","ArrowUp"],["ArrowDown","ArrowDown"],["ArrowLeft","ArrowLeft"],["ArrowRight","ArrowRight"],["Home","Home"],["End","End"],["PageUp","PageUp"],["PageDown","PageDown"],["Escape","Escape"],["Insert","Insert"],["F1","F1"],["F2","F2"],["F3","F3"],["F4","F4"],["F5","F5"],["F6","F6"],["F7","F7"],["F8","F8"],["F9","F9"],["F10","F10"],["F11","F11"],["F12","F12"]]);
...
// === ADVANCEDAPIS SPOOFING ===
  
(function() {
  'use strict';
  
  const config = {"pdf":{"enabled":true,"pdfViewerEnabled":true},"bluetooth":{"enabled":false},"usb":{"enabled":false},"gamepad":{"mode":"hide"},"history":{"mode":"minimal","length":1},"clipboard":{"mode":"ask"},"notification":{"mode":"deny"},"serviceWorker":{"enabled":true},"webAssembly":{"enabled":true},"sharedArrayBuffer":{"enabled":true},"atomics":{"enabled":true},"credentials":{"enabled":false},"payment":{"enabled":false},"presentation":{"enabled":false}};
...
(function() {
  ...
  const config = {"browser":{"type":"chrome","version":"120.0.0.0","majorVersion":120},"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36","acceptLanguage":"en-US,en;q=0.9","platform":"Windows","mobile":false,"emulateChrome":true,"cleanElectronTraces":true,"hideAutomation":true};
...
// === SCREEN SPOOFING ===
  ...
  try {
    ...
    try {
      Object.defineProperty(w.screen,'width',{get:function(){return 2560;},configurable:true,enumerable:true});
      Object.defineProperty(w.screen,'height',{get:function(){return 1440;},configurable:true,enumerable:true});
      Object.defineProperty(w.screen,'availWidth',{get:function(){return 2560;},configurable:true,enumerable:true});
      Object.defineProperty(w.screen,'availHeight',{get:function(){return 1440;},configurable:true,enumerable:true});
    ...
    try {
      if (window.Screen && window.Screen.prototype) {
        ...
        Object.defineProperty(proto,'width',{get:function(){return 2560;},configurable:true,enumerable:true});
        Object.defineProperty(proto,'height',{get:function(){return 1440;},configurable:true,enumerable:true});
        Object.defineProperty(proto,'availWidth',{get:function(){return 2560;},configurable:true,enumerable:true});
        Object.defineProperty(proto,'availHeight',{get:function(){return 1440;},configurable:true,enumerable:true});
    ...
    try {
      Object.defineProperty(w,'innerWidth',{get:function(){return 2560;},configurable:true,enumerable:true});
      Object.defineProperty(w,'innerHeight',{get:function(){return 1440;},configurable:true,enumerable:true});
      Object.defineProperty(w,'outerWidth',{get:function(){return 2560;},configurable:true,enumerable:true});
      Object.defineProperty(w,'outerHeight',{get:function(){return 1440;},configurable:true,enumerable:true});
  ...
  try {
    ...
    __mockScreen.width = 2560;
    __mockScreen.height = 1440;
    __mockScreen.availWidth = 2560;
    __mockScreen.availHeight = 1440;
    ...
    var __prox = new Proxy(__sc, {
      get: function(t, p, r) {
        if (p === 'width') return 2560;
        if (p === 'height') return 1440;
        if (p === 'availWidth') return 2560;
        if (p === 'availHeight') return 1440;
  ...
  try {
    if (window.visualViewport) {
      ...
      Object.defineProperty(window.visualViewport,'width',{get:function(){return 2560;},configurable:true,enumerable:true});
      Object.defineProperty(window.visualViewport,'height',{get:function(){return 1440;},configurable:true,enumerable:true});
    }
  } catch(e) {}
  try {
